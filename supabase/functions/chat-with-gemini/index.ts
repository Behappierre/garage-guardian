  ...
  try {
    ...
    switch (queryType) {
      ...
      case 'job_sheet':
        ...
        break
      default:
        response = "I'm not sure how to help with that specific query. Could you please rephrase or ask something about appointments, vehicles, clients, or job sheets?"
    }
