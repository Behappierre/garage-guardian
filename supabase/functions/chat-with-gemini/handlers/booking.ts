// Similar to the GPT version, but for the Gemini function
// (The implementation would be almost identical to the GPT version)
...
Bay: ${appointmentData.bay}`;
    ...
    return `There was an error processing your booking request: ${error.message}`;
  }
}

// Function to handle appointment modifications with conversation state
