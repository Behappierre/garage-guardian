...
export function ChatLauncher({ onClick, isDisabled = false }: ChatLauncherProps) {
  return (
    <Button
      size="icon"
      className={cn(
        "fixed bottom-4 right-4 h-32 w-32 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-in fade-in-50 zoom-in-95 p-0 overflow-hidden z-50",
